...
export interface CardProps extends React.HTMLAttributes<HTMLDivElement> {
    variant?: 'default' | 'elevated' | 'bordered' | 'interactive' | 'glass' | 'glass-strong' | 'glass-premium' | 'glass-vibrant' | 'hover';
    padding?: 'none' | 'sm' | 'md' | 'lg' | 'xl';
    glassIntensity?: 'light' | 'medium' | 'heavy';
    gradient?: boolean;
    children: React.ReactNode;
}
export declare const Card: ({ variant, padding, glassIntensity, gradient, children, className, ...props }: CardProps) => import("react/jsx-runtime").JSX.Element;
