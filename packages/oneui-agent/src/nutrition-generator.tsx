...
// Helper Mappers
const mapGender = (sex: string): Sex | null => {
    ...
    <div className="space-y-8">
      <div className="space-y-4">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          {[
            {
              id: DIET_TYPES.OMNIVORE,
              label: 'Onnivoro',
              desc: 'Nessuna restrizione specifica',
            },
            {
              id: DIET_TYPES.VEGETARIAN,
              label: 'Vegetariano',
              desc: 'No carne, sì derivati animali',
            },
            { id: DIET_TYPES.VEGAN, label: 'Vegano', desc: 'Nessun prodotto animale' },
            { id: DIET_TYPES.PESCATARIAN, label: 'Pescatariano', desc: 'Vegetariano + pesce' },
            {
              id: DIET_TYPES.KETO,
              label: 'Chetogenica',
              desc: 'Alto grassi, carboidrati minimi',
            },
            { id: DIET_TYPES.PALEO, label: 'Paleo', desc: 'Alimenti non processati' },
            {
              id: DIET_TYPES.MEDITERRANEAN,
              label: 'Mediterranea',
